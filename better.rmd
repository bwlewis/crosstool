...
p = c(0.999, 0.99, 0.98, 0.97, 0.96, 0.95, 0.9, 0.85)
g = Map(f, p)
...
span = widget("receiver", "<span style='font-size:16pt;'>0.999</span>", value="innerText", crosstalk=sd, width="100%", indexed=label.set)
