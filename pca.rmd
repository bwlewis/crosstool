...
Clarifying ealier results and introducing new ones, their paper shows in
particular that:
...
simply record that zero means an person does not contain a particular variant,
and a one means that a person does contain the variant (ignoring other
...
in the example below. This leavs open the idea of using a comparitavely cheap
network community-detection algorithm as a starting point for k-means
implementations.

I really love that, by explicitly illustrating connections between observations,
